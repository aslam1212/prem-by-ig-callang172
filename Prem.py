...
exit(f"{P}[{K}!{P}]{K} Koneksi Error")
print(f"{B}[{P}1{B}]{P} 𝙳𝚞𝚖𝚙 𝚄��𝚎��𝚗��𝚖�� 𝙳𝚊𝚛𝚒 ��𝚎��𝚐��𝚔��𝚝��")
print(f"{B}[{P}2{B}]{P} 𝙳𝚞𝚖𝚙 𝚄��𝚎��𝚗��𝚖�� 𝙳𝚊𝚛𝚒  𝙿𝚎𝚗𝚐𝚒𝚔𝚞𝚝")
print(f"{B}[{P}3{B}]{P} 𝙳𝚞𝚖𝚙 𝚄��𝚎��𝚗��𝚖�� 𝙳𝚊𝚛𝚒  𝙰𝚌𝚝𝚒𝚟𝚒𝚝𝚢")
print(f"{B}[{P}4{B}]{P} 𝙳𝚞𝚖𝚙 𝚄��𝚎��𝚗��𝚖�� 𝙳𝚊𝚛𝚒  𝙱𝚎𝚛𝚊𝚗𝚍𝚊")
print(f"{B}[{P}5{B}]{P} 𝙳𝚞𝚖𝚙 𝚄��𝚎��𝚗��𝚖�� 𝙳𝚊𝚛𝚒 ��𝚊��𝚝��𝚐")
print(f"{B}[{P}6{B}]{P} 𝙳𝚞𝚖𝚙 𝚄��𝚎��𝚗��𝚖�� 𝙳𝚊𝚛𝚒 ��𝚎��𝚛��𝚑")
print(f"{B}[{P}7{B}]{P} 𝙳𝚞𝚖𝚙 𝚄��𝚎��𝚗��𝚖�� 𝙳𝚊𝚛𝚒 ��𝚞��𝚛��")
print(f"{B}[{P}8{B}]{P} 𝙳𝚞𝚖𝚙 𝚄��𝚎�� 𝙳𝚊𝚛𝚒 ��𝚖��𝚒��")
print(f"{B}[{P}9{B}]{P} 𝙼𝚞𝚕𝚊𝚒 ��𝚛��𝚌�� {P}[{H}𝔽��𝕤��{P}]{H}")
print(f"{B}[{P}0{B}]{P} 𝙻𝚒𝚑𝚊𝚝 ��𝚊��𝚒�� 𝙲𝚛𝚊𝚌𝚔")
print(f"{B}[{P}A{B}]{P} 𝙺𝙴𝙻𝚄𝙰𝚁 {P}[{M}Exit{P}]{M}\n")
___pilih = input(f"{H}[{P}?{H}]{P} ��𝙸��𝙸�� :{K} ")
if ___pilih in ['1','01']:
___mengikuti___()
